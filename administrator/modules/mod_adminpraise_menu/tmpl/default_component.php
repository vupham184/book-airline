...
// window.open
?>
<a <?php echo $class; ?>href="<?php echo $item->flink; ?>" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes');return false;" title="<?php echo JText::_($item->title); ?>">
    <?php if($item->deeper) : ?>
        <span class="subarrow"></span>
    <?php endif; ?>
    <span class="component-image"></span>
