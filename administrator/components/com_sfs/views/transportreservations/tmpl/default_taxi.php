	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="10%" style="text-align:left;text-indent:5px;">
					<a href="#" style="text-align:left;text-indent:5px;">Departure/Time</a>
				</th>					
				<th width="100"><a href="#">Comment</a></th>
				<th width="100"><a href="#">Return Comment</a></th>												
			</tr>
		</thead>
		<tfoot>
			<tr>
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>		
					<div>
						T: <?php echo $item->taxi_name;?>
					</div>
					<div> 				
						H: <?php echo $item->hotel_name;?>
					</div> 									   
				</td>								
				<td>
