 ...
 * Currency view
 */
class SfsViewCurrency extends JView
{
	/**
	 * @return void
	 */
	...
	protected function addToolBar() 
	{
		...
		$this->canDo 	= sfsHelper::getActions($this->item->id, 'currency');
		
		JToolBarHelper::title($isNew ? JText::_('COM_SFS_MANAGER_CURRENCY_NEW') : JText::_('COM_SFS_MANAGER_CURRENCY_EDIT'), 'currency');
