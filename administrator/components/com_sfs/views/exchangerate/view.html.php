 ...
 * Currency view
 */
class SfsViewExchangerate extends JView
{
	/**
	 * @return void
	 */
	...
	protected function addToolBar() 
	{
		...
		$this->canDo 	= sfsHelper::getActions($this->item->id, 'exchangerate');
		...
		if ($isNew) 
		{
			...
			{
				JToolBarHelper::apply('exchangerate.apply', 'JTOOLBAR_APPLY');
				JToolBarHelper::save('exchangerate.save', 'JTOOLBAR_SAVE');
				JToolBarHelper::custom('exchangerate.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
			}
			
			JToolBarHelper::cancel('exchangerate.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			...
			// }
			JToolBarHelper::cancel('exchangerate.cancel', 'JTOOLBAR_CLOSE');
		}
	}
