...
?>
<form action="<?php echo JRoute::_('index.php?option=com_sfs&view=managetamplatemobiles'); ?>" method="post" name="adminForm">
	...
	<table class="adminlist">
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td align="center"><?php echo substr($item->logo_header, 0, 50) . "..."; ?></td>
				<td align="center"><?php echo substr($item->logo_voucher, 0, 50) . "..."; ?></td>	
				<td align="center"><?php echo substr($item->logo_creditcard, 0, 50) . "..."; ?></td>
				<td align="center"><?php echo $item->color_MB; ?></td>	
				<td align="center"><?php echo $item->color_MT; ?></td>	
				<td align="center"><?php echo $item->color_MVB; ?></td>	
				<td align="center"><?php echo $item->color_MVT; ?></td>	
				<td align="center"><?php echo $item->color_MBB; ?></td>						
			</tr>
		<?php endforeach; ?>
		</tbody>
