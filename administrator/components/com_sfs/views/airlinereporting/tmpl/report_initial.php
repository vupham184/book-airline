...
<div class="report-chart-wrap">					
	...
	<center>
		...
		<img src="<?php echo JURI::base().'index.php?option=com_sfs&task=airlinereporting.drawpie&format=raw&points=100';?>" />
		<?php else: ?>
		<img src="<?php echo JURI::base().'index.php?option=com_sfs&task=airlinereporting.drawpie&format=raw&points='.$this->initialPercentages->claimed_rooms.','.($this->initialPercentages->initial_rooms-$this->initialPercentages->claimed_rooms);?>" />
		<?php endif;?>			
	</center>
</div>
