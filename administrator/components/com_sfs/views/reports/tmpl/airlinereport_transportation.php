...
<div class="report-chart-wrap">					
	...
	<center>
		<img src="<?php echo JURI::base().'index.php?option=com_sfs&task=reports.drawpie&format=raw&airline_id='.$airlineId.'&points='.$this->transportationPercentages[0].','.$this->transportationPercentages[1];?>" />	
	</center>
</div>
