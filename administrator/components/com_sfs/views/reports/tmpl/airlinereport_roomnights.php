...
<div class="report-chart-wrap report-chart-wrap-1">
	...
	<center>
		<img src="<?php echo JURI::base().'index.php?option=com_sfs&task=reports.airlinechart&format=raw&type=1&airline_id='.$airlineId.'&points='.implode(',',$points).'&dates='.implode(',',$dates);?>" />	
	</center>
	</div>
</div>
