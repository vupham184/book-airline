...
?>
<div class="report-chart-wrap report-chart-wrap-1">
	<h3>Average room prices booked</h3>
	<div class="report-chart-img">
	<center>
		<img src="<?php echo JURI::base().'index.php?option=com_sfs&task=reports.airlinechart&format=raw&type=2&airline_id='.$airlineId.'&points='.implode(',',$points).'&dates='.implode(',',$dates);?>" />	
	</center>
	</div>
</div>
