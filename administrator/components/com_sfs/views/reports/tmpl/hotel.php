...
<div class="width-100">
	<form action="<?php echo JRoute::_('index.php?option=com_sfs&view=reports&layout=hotel&hotel_id='.$this->hotel->id)?>" method="post" id="hotelReportForm" name="hotelReportForm">
		<fieldset>
			<h1>Hotel Report: <?php echo $this->hotel->name;?></h1>
		...
		<input type="hidden" name="task" value="reports.hotelReport">
