...
<div style="padding: 20px;">
	<h2>New User for <?php echo $this->groupTransport->name?></h2>	
	<form action="<?php echo JRoute::_('index.php?option=com_sfs'); ?>" method="post" name="userForm" id="userForm" class="form-validate">
		<div>
			<table >
				<tr>
					<td>Username</td>
		...
		<input type="hidden" name="id" value="<?php echo $this->groupTransport->id?>" />
		<input type="hidden" name="task" value="grouptransport.newUser" />	
