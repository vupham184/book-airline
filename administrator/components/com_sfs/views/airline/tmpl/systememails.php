...
<form action="<?php echo JRoute::_('index.php?option=com_sfs&view=airline&layout=systememails&id='.$this->item->id); ?>" method="post" name="adminForm">
	<div class="width-100 ">
	...
	<fieldset>
		...
		<div>
			...
			<input type="hidden" name="task" value="airline.saveSystemEmails" />
			<input type="hidden" name="option" value="com_sfs" />	        
			<input type="hidden" name="airline_id" value="<?php echo $this->item->id; ?>" />			
