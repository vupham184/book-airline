...
?>
<form action="<?php echo JRoute::_('index.php?option=com_sfs&view=ghs');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :					
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>			
					<a href="<?php echo JRoute::_('index.php?option=com_sfs&task=gh.edit&id='.$item->id);?>">
