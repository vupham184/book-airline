...
class SfsControllerAirlines extends JController
{
	...
	function publish()
	{
		...
		if (empty($cid)) {
			...
			// Get the model.
			$model = $this->getModel('Airlines','SfsModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_sfs&view=airlines', false));
	}
