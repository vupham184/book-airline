 ...
 * Currency Controller
 */
class SfsControllerCurrency extends JControllerForm
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_sfs.currency.'.$recordId)) {
			return true;
		}

		// Fallback on edit.own.
		// First test if the permission is available.
		if ($user->authorise('core.edit.own', 'com_sfs.currency.'.$recordId)) {
	...
	public function batch()
	{
		...
		// Preset the redirect
		$this->setRedirect('index.php?option=com_sfs&view=currencies');
