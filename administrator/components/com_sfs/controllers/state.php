 ...
 * State Controller
 */
class SfsControllerState extends JControllerForm
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_sfs.state.'.$recordId)) {
			return true;
		}

		// Fallback on edit.own.
		// First test if the permission is available.
		if ($user->authorise('core.edit.own', 'com_sfs.state.'.$recordId)) {
	...
	public function batch()
	{
		...
		// Preset the redirect
		$this->setRedirect('index.php?option=com_sfs&view=states');
