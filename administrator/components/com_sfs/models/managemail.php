 ...
 * Exchangerate Model
 */
class SfsModelManagemail extends JModelAdmin
{
	/**
	...
	protected function canDelete($record)
	{
		...
		return $user->authorise('core.delete', 'com_sfs.managemail.'.(int) $record->id);
	}
	...
	protected function canEditState($record)
	{
		...
		if (!empty($record->id)) {
			return $user->authorise('core.edit.state', 'com_sfs.managemail.'.(int) $record->id);
		}
		// Default
		else {
	...
	{
		// Get the form.
		$form = $this->loadForm('com_sfs.managemail', 'managemail', array('control' => 'jform', 'load_data' => $loadData));
		...
		if ($id = (int) $this->getState('managemail.id')) {
