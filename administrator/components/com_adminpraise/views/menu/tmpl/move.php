...
<script language="javascript" type="text/javascript">
		Joomla.submitbutton = function(pressbutton) {
			...
			if (!getSelectedValue( 'adminForm', 'menu' )) {
				alert( "<?php echo JText::_( 'COM_ADMINPRAISE_SELECT_MENU_LIST', true ); ?>" );
			} else {
				Joomla.submitform( pressbutton );
			}
		}
...
<form action="index.php" method="post" name="adminForm">
	<table class="adminform">
		<tr>
			...
			<strong><?php echo JText::_( 'COM_ADMINPRAISE_MOVE_MENU' ); ?>:</strong>
			<br />
			...
			<td  valign="top">
			<strong>
			<?php echo JText::_( 'COM_ADMINPRAISE_MENU_ITESM_BEING_MOVED' ); ?>:
			</strong>
			<br />
			<ol>
