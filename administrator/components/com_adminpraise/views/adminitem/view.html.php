 ...
 * @since		1.6
 */
class AdminpraiseViewAdminitem extends JView
{
	protected $form;
	protected $item;
	protected $modules;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_($isNew ? 'COM_ADMINPRAISE_VIEW_NEW_ITEM_TITLE' : 'COM_ADMINPRAISE_VIEW_EDIT_ITEM_TITLE'), 'menu-add');
