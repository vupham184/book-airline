...
<form action="<?php echo JRoute::_('index.php?option=com_content&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
    <div class="width-100">
        ...
        <?php echo JHtml::_('tabs.panel',JText::_('COM_CONTENT_ARTICLE_DETAILS'), 'article-details'); ?>
        ...
        <?php
        // Do not show the publishing options if the edit form is configured not to.
        if ($params['show_publishing_options'] || ( $params['show_publishing_options'] = '' && !empty($editoroptions)) ): ?>
        ...
        <?php  echo JHtml::_('tabs.panel', JText::_('COM_CONTENT_SLIDER_EDITOR_CONFIG'), 'configure-sliders'); ?>
        <fieldset  class="panelform" >
            <ul class="adminformlist">
