...
<title>SFS roomloading requested for your hotel</title>
</head>
<body>
      ...
      <td style="font-size:12px;font-family:'lucida grande',tahoma,verdana,arial,sans-serif">
        ...
        <table cellspacing="0" cellpadding="0" style="border-collapse:collapse;width:620px">
            ...
            <tr>
				...
				The reason for this can be expected mass disruption or high occupancy levels on the hotel market.
                <br /><br />
				...
				Main Office Telephone: +31 35 678 1255<br />
				Main Email: info@sfs-web.com
				</p>
                </td>
            </tr>
            </tbody>
