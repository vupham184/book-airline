...
?><div style="padding:10px; margin-top:10px;font-family: 'lucida grande', tahoma, verdana, arial, sans-serif">
	<div class="container-card" style="width:945px;margin:auto;color:#828282;">
    	...
    	<div class="card-view" style="float:left;width:445px;border:2px solid #999999;height:290px;border-radius:10px;box-shadow: 1px 16px 7px -2px rgba(153, 153, 153, 0.27);-moz-box-shadow: 1px 16px 7px -2px rgba(153, 153, 153, 0.27);-webkit-box-shadow: 1px 16px 7px -2px rgba(153, 153, 153, 0.27); margin-right:24px;">
        	<div class="card-view-top" style="padding-left:32px; height:70px;position:relative;">
            	<div class="card-view-text" style="position:absolute;top:52px;text-transform:uppercase; padding-top:52px; float:left;">
                	creditcard
                </div>
           ...
           <div class="card-view-name-logo" style="padding-left:32px;position:relative;margin-top:33px;">
        ...
        <div class="card-back" style="float:left;width:445px;border:2px solid #999999;height:290px;border-radius:10px;">
        	<div class="card-back-line" style="background-color: #999999;margin-top:42px;height:50px;"></div>
            <div class="card-back-code-text" style="margin-top:35px;">
            	<div class="card-back-code" style="float:left;height:48px;border:1px solid #999999;margin-left:10px;width:258px;position:relative;">
                	<div class="card-back-code-sub-text bold" style="position:absolute;right:-1px;top:-1px;border:1px solid #f00;width:51px;text-align:right;padding:5px; float:right;">
                    	<?php echo $info_of_card->CVC;?>
                    </div>
                    <div class="card-back-code-sub-text-bottom" style="margin-top:28px;margin-left:20px;text-transform:uppercase;">
                    	<?php echo $info_of_card->PassengerName;?>
                    </div>
            	</div>
                <div class="card-back-text" style="float:left;height:48px;margin-left:5px;width:auto;">
                	CVC Code
            	</div>
                <br class="br-clear" style="clear:both;" />
