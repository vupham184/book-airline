...
$logo = JURI::base().'/media/upload/navigation_logos.png';
    		...
    		<div class="card-view">
	        	<div class="card-view-top">
	                ...
	                <div class="card-view-logo-top">
						<img src="<?php echo $logo; ?>" height="45" />
	                </div>
	            ...
	            <div class="card-view-text-numbers bold">
	            	<span class="bold"><?php echo substr($cardNum, 0,4);?></span>
	                <span class="bold"><?php echo substr($cardNum, 4,4);?></span>
	                <span class="bold"><?php echo substr($cardNum, 8,4);?></span>
	                <span><?php echo substr($cardNum, -4);?></span>
	                <span class="small"><?php echo substr($cardNum, 0,4);?></span>
	            </div>
	            ...
	            <div class="card-back-code-text">
	            	<div class="card-back-code">
	                    ...
	                    <div class="card-back-code-sub-text-bottom">
	                    	<?php echo $info_of_card_train->name;?>
	                    </div>
	            	</div>
