...
<div class="block-group">
    <div class="block border orange">
        <div class="sfs-white-wrapper floatbox">
            <legend><?php if($i<2){echo ( $i == 0  ) ? JText::_('COM_SFS_MAIN_CONTACT') : JText::_('COM_SFS_AIRLINE_YOUR_TEAM_MEMBERS') ;} else {echo JText::_('COM_SFS_AIRLINE_ADDITIONAL_CONTACTS');} ?></legend>
            <fieldset>
