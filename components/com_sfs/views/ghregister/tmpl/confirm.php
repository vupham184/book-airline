    ...
    <form id="airlineRegisterForm" name="airlineRegisterForm" action="<?php echo JRoute::_('index.php?option=com_sfs'); ?>" method="post">
        <div class="sfs-main-wrapper-none">        
        	<div class="sfs-orange-wrapper">
            	<div class="sfs-white-wrapper floatbox" style="padding-top: 0">
                	<div class="fs-11" style="padding-top: 0">
                		<?php 
        ...
        <div class="sfs-below-main">
        	<ul class="menu-command float-right" >
	        	<li>
	            	<input type="submit" class="button" value="<?php echo JText::_('COM_SFS_SAVE_AND_FINISH_BUTTON')?>">
	            </li>
            </ul>
        </div>
        
        <input type="hidden" name="task" value="ghregister.confirm" />
