...
<div class="blockstatus">
    <h3 class="introtitle"><?php echo JText::_('COM_SFS_BLOCK_STATUS_OPEN');?></h3>
    
    <div class="blockreview">
        <p class="reviewp">
	        <?php echo JText::_('COM_SFS_BLOCK_STATUS_OPEN_DESC');?>               
        </p>
        ...
        <div style="padding:15px;width:450px;margin:0 auto">
            ...
            ?>  
                <tr class="<?php echo ($i%2) ? 'odd':'even' ?>" valign="middle">
                    <td><?php echo ++$i;?></td>
                    <td><?php echo JHTML::_('date',$date,'d-m-Y');?></td>
                    <td class="last"><?php echo $block->blockcode;?></td>						
                    <td class="blank" style=" padding:2px 0 2px 15px">
                    	
                    	<?php if($i==1):?>
                    		<?php echo JText::_('<a href='.$link.' class=small-button >'.JText::_('COM_SFS_LOAD').'</a>' ,'hotel');?>
                    	<?php else:?>
        ...
        <p><?php echo JText::_('COM_SFS_BLOCK_STATUS_OPEN_NOTE');?></p>
