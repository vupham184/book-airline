...
<div id="sfs-wrapper" class="fs-14 main">
	...
	<div class="sfs-white-wrapper floatbox">
		...
		<div class="uk-alert uk-alert-success" style="font-size:14px;">
			You have been accepted group bus transportation booking for <?php echo $this->reservation->total_passengers?> persons
		</div>	
