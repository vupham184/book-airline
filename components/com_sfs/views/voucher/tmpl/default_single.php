...
<div class="main_specific">
    ...
    <p>
        ...
        <?php if(isset($this->passengers[0]->phone_number)):?>
            Telephone number:  <?php echo $this->passengers[0]->phone_number;?><br />
        <?php endif;?>

        Hotel Voucher Code: <?php echo $this->voucher_groups->code; ?><br />
        Voucher <?php if($count_trace_passengers > 0 ) echo "for ".$this->voucher_groups->seats." person(s)";?> entitled for:<br />
    ...
    <?php if( (int)$mealplan && (int)$v_mealplan ) : ?>
        <?php
        $stopSellingTime = $mealplan->stop_selling_time;//var_dump($mealplan->stop_selling_time);die();
...
<?php if($this->voucher->return_flight_number) : ?>
    Your new flight details: Flight number <?php echo $this->voucher->return_flight_number?> departure date <?php echo JHTML::_('date', $return_flight_date , JText::_('DATE_FORMAT_LC3'), false )?><br/><br/>
<?php endif;?>
...
<?php endif;
if( $this->voucher->flight_code == '' ){
	$this->voucher->flight_code = (isset($_GET['flight_number'])) ? $_GET['flight_number'] : '';
}
?>
...
<div style="background-color:#FFDE73; border:solid 10px #FFB700; padding:10px; margin-top:15px;font-family: 'lucida grande', tahoma, verdana, arial, sans-serif; ">
    <p style="font-weight: bold;margin-top:5px;">
        ...
        <?php echo 'Voucher code: '.$this->voucher_groups->code?><br />
        <?php echo 'Voucher '.$this->voucher_groups->seats.' person'?><br />
        <?php if($this->voucher->return_flight_number) : ?>
