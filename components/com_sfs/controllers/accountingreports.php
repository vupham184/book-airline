...
class SfsControllerAccountingreports extends JController {
	...
	public function TracepassExportExcel()
	{
    	...
    	$model = $this->getModel('Accountingreports');	
		...
		$objPHPExcel->setActiveSheetIndex(0)
					->setCellValueByColumnAndRow( 4, $row, 'PNR:' ,false);
		$objPHPExcel->setActiveSheetIndex(0)
		...
		->getStyle('I'.$top_row.':I'. $row)
		->getNumberFormat()
		->setFormatCode('#,##0.00');*/
		
		/*$objPHPExcel->getActiveSheet()
		->getStyle('P'.$top_row.':P'. $row)
		->getNumberFormat()
		->setFormatCode('#,##0.00'); */
