...
<div class="wellcomepart" style="float:right;overflow:hidden;">
	...
	<div class="namecountry">
		Airline name: <span style="color:red;"><?php echo $selectedAirline->name;?></span>
		<?php	
		$contractDetails = $airline->getContractDetails();	
		if( $contractDetails ) :
		JHtml::_('behavior.tooltip');
		?>		
		<span class="hasTip" style="text-decoration: underline;" title="<?php echo $contractDetails;?>">Contract detais</span>		
		<?php endif;?>
	</div>
	<div class="datetime">
